...
describe('Database', function () {
    ...
    it('Testing the instantiation of a Database object', function () {
        ...
        expect(function () {
            return new \BDSCore\Database\Database('d', 'databaseTest');
        })->toThrow(new \BDSCore\Database\DatabaseException);
        expect(new \BDSCore\Database\Database('sqlite', 'databaseTest'))->toBeAnInstanceOf('BDSCore\Database\Database');
    });

    it('Test sending data to a sqlite database.', function () {
        $database = new \BDSCore\Database\Database('sqlite', 'databaseTest');
